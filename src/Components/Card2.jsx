...
function Card2({name,price,image,id,qty}) {
  ...
  return (
    <div className='w-[100%] h-[150px] shadow-lg flex justify-between p-2'>
      <div className='w-[60%] h-full p-2 flex gap-5'>
        ...
        <div className='w-[40%] h-full flex flex-col gap-5'>
          ...
          <div className='w-[110px] h-[40px] flex bg-yellow-400 rounded-lg overflow-hidden shadow-lg font-semibold border-2 border-green-400'>
